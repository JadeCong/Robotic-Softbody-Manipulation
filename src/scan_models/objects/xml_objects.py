...
class SoftBoxObject(MujocoXMLObject):
    ...
    def __init__(self, name, damping=None, stiffness=None):
        super().__init__("scan_models/assets/objects/soft_box.xml", name=name, duplicate_collision_geoms=False)
...
class BoxObject(MujocoXMLObject):
    ...
    def __init__(self, name):
        super().__init__("scan_models/assets/objects/box.xml", name=name)
